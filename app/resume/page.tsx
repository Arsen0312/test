            ...
            <div className="font-sans w-[90%] mx-auto ">
                ...
                <section className="mt-12 pb-40">
                    ...
                    <div className="pl-8 pr-8">
                        <div className="flex">
                            <h2>Programming languages:</h2> TypeScript, JavaScript,
                        </div>
                        <div className="flex">
                            <h2>Frontend:</h2> React, Next.js, Vue3, HTML5, CSS3, SCSS, styled components, swiper, i18n,
                            redux, redux-toolkit, pinia,
                            react-hook-form, Web socket, REST API, eslint, vue-draggable-plus
                        </div>
                        <div className="flex">
                            <h2>languages:</h2> Kyrgyz(Native), Russian (Native)
                        </div>
                    </div>
                </section>
            </div>
